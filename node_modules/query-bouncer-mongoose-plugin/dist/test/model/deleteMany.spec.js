...
describe('deleteMany', () => {
    ...
    it('will correctly delete documents the user has permission to', async () => {
        ...
        // Assert
        (0, chai_1.expect)(blogPost).to.deep.equal({ deletedCount: 2 });
    });
    it('will not delete a Document the user has no permission to', async () => {
        ...
        const blogPost = await BlogPost.deleteMany(originalQuery, { MongoBouncer });
        // Assert
        (0, chai_1.expect)(blogPost).to.deep.equal({ deletedCount: 0 });
    });
    it('will still delete the Document if MongoBounce is not activated', async () => {
        ...
        // Assert
        (0, chai_1.expect)(blogPost).to.deep.equal({ deletedCount: 1 });
    });
    afterEach(async () => {
        mock.restore();
...
//# sourceMappingURL=deleteMany.spec.js.map