...
describe('findOneAndRemove', () => {
    ...
    it('will correctly delete a Document the user has permission to', async () => {
        ...
        // Assert
        (0, chai_1.expect)(blogPost.toObject()).excluding(['__v', '_id']).to.deep.equal({ Title: 'New Food', Description: 'Stuff about super food', Category: 'Food' });
    });
    it('will not delete a Document the user has no permission to', async () => {
        ...
        const blogPost = await BlogPost.findOneAndRemove(originalQuery, { MongoBouncer });
        // Assert
        (0, chai_1.expect)(blogPost).to.equal(null);
    });
    afterEach(async () => {
        mock.restore();
...
//# sourceMappingURL=findOneAndRemove.spec.js.map